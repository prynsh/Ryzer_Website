  ...
  return (
    <div className="md:space-y-7 space-y-10">
      ...
      <div>
        ...
        <h1 className="md:text-6xl text-4xl font-bold text-center text-neutral-800">
          Own & hold it
      ...
      <div>
        <div className="relative flex flex-col items-center space-y-8 py-20">
          {/* Main Image */}
          <div className="relative md:w-[500px] md:h-[500px] w-[380px] h-[380px]">
            ...
            {features.map((feature, i) => (
              <div
                ...
                className="hidden  absolute whitespace-nowrap bg-[#f9f9f9] px-6 py-2 rounded-full hover:shadow-md font-medium text-neutral-700 text-sm md:flex items-center gap-2"
                style={{
                  top: feature.y,
                  left: feature.x,
...
Breaking barriers to asset ownerships"
      ...
      <div className="p-3 space-y-5">
        <h1 className="md:text-6xl text-4xl font-phudu font-bold text-center text-neutral-800">MULTI-ASSETS, ON THE WAY</h1>
        <p className="font-vietnam text-center"> Ryzer platform working hard to provide access to a wide range of asset types and <span className="hidden lg:inline">
              <br />
            </span> benefit from holding digital assets across multiple jurisdictions.</p>
      </div>
      <CardStack/>
    </div>
  );
