...
const FeatureCards = () => {
  ...
  return (
    <div
      ...
      className="flex flex-col items-center justify-center px-6 md:py-10  gap-6 sm:flex-row sm:flex-wrap sm:justify-center md:gap-10 md:px-12 lg:px-24"
    >
      {data.map((item, index) => (
        <div
          key={index}
          className="feature-cards w-full sm:w-[45%] md:w-[30%] min-h-80 bg-[#1b1a1a] text-white p-6 rounded-3xl flex flex-col justify-between"
        >
          {/* Top Section */}
          <div>
            <div className="text-xl font-bold">{item.id}</div>
